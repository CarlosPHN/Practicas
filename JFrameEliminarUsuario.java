	...
	public JFrameEliminarUsuario() {
		...
		btnEliminarUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					eliminado=GestorUsuario.eliminarUsuario(textFieldLogin.getText(), textFieldPassword.getText());
					if(eliminado){
					...
					textPane.setText("Comprueba si has creado la base de datos"); //Igual la base de datos no existe
				}
		...
		btnEliminarUsuario.setBounds(253, 76, 141, 29);
